...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      "The site you're looking at. Dot-field background, retro pixel-button accents and a project section that tries to feel like both a gallery and a terminal.",
